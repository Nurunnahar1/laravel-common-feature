            ...
            <div class="card-body">
                ...
                @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="client_name" class="form-control" @error('client_name') is-invalid   @enderror placeholder="enter client name" id="">
                            @error('client_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="client_designation" class="form-control" @error('client_designation') is-invalid   @enderror placeholder="enter client name" id="">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="client_message" class="form-control" @error('client_message') is-invalid   @enderror id="" cols="30" rows="10"></textarea>
