...
@section('admin_content')
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('cupon.update',$coupon->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="number" min="0" name="discount_amount" value="{{ $coupon->discount_amount }}" class="form-control" id="discount_amount">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" name="minimum_purchase_amount" value="{{ $coupon->minimum_purchase_amount }}" min="0" class="form-control @error('minimum_purchase_amount') is-invalid   @enderror" id="minimum_purchase_amount">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="date" name="validity_till" value="{{ $coupon->validity_till }}" class="form-control @error('validity_till') is-invalid  @enderror" id="validity_till" placeholder="enter a unique product code">
                            @error('validity_till')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
