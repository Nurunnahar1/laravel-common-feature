       ...
       <section class="project__section project__section--bg section--padding">
        <div class="container">
            ...
            <ul class="project__tab--one project__tab--btn d-flex justify-content-center mb-40">
                ...
                <li class="project__tab--btn__list" data-toggle="tab" data-target="#architecture">Architecture
                </li>
                                    ...
                                    <a class="project__card--link" href="shop.html">
                                        ...
                                        <div
                                            ...
                                            <div class="project__card--content__left">
                                                ...
                                                <span class="project__card--content__subtitle">Products
                                                    Manager</span>
                                            </div>
                                            <span class="project__card--btn"><svg class="project__card--btn__svg"
                                                    xmlns="http://www.w3.org/2000/svg" width="15.51"
                                ...
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        ...
                                        <div
                                            ...
                                            <div class="project__card--content__left">
                                                <h3 class="project__card--content__title">Sarrison Samuel</h3>
                                                <span class="project__card--content__subtitle">CEO -
                                                    Founder</span>
                                            </div>
                                            <span class="project__card--btn"><svg class="project__card--btn__svg"
                                                    xmlns="http://www.w3.org/2000/svg" width="15.51"
