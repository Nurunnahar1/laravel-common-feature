                        ...
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__logo" href="index.html"><img
                                        class="footer__logo--img display-block"
                                    ...
                                    <ul class="social__shear d-flex">
                                        <li class="social__shear--list">
                                            <a class="social__shear--list__icon" target="_blank"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="8.239"
                                                    height="15.984" viewBox="0 0 11.239 20.984">
                                        ...
                                        <li class="social__shear--list">
                                            <a class="social__shear--list__icon" target="_blank"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                    height="14.492" viewBox="0 0 24 19.492">
                                        ...
                                        <li class="social__shear--list">
                                            <a class="social__shear--list__icon" target="_blank"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14.497"
                                                    height="14.492" viewBox="0 0 19.497 19.492">
                                        ...
                                        <li class="social__shear--list">
                                            <a class="social__shear--list__icon" target="_blank"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14.419"
                                                    height="14.419" viewBox="0 0 19.419 19.419">
                                        ...
                                        <li class="social__shear--list">
                                            <a class="social__shear--list__icon" target="_blank"
                                                href="https://www.linkedin.com">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="15.49"
                                                    height="15.582" viewBox="0 0 16.49 11.582">
