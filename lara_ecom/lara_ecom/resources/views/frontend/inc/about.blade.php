                    ...
                    <div class="col">
                        <div class="about__content">
                            ...
                            <div class="about__content--step mb-25">
                                ...
                                <ul class="mb-20">
                                    <li class="about__content--desc__list">Beyond drone is an to be contre unmanned
                                        aerial.</li>
                                    <li class="about__content--desc__list">With various equipment including tho drone.
                                    </li>
                                </ul>
                                <p class="about__content--desc style2">Beyond more stoic this along goodness this sed
                                    wow
                            ...
                            <div class="about__content--author d-flex align-items-center mb-50">
                                <div class="about__content--author__thumb">
                                    <img class="display-block" src="assets/img/other/about-author.webp"
                                ...
                                <div class="about__content--author__text d-flex align-items-center">
                                    ...
                                    <img class="about__author--signature display-block"
                                        src="assets/img/icon/signature.webp" alt="signature">
                                </div>
                            </div>
